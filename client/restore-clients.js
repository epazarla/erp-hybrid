// Müşteri verilerini geri yükleme kodu
...
// Tarayıcı konsolunda çalıştırmak için bu kodu kopyalayın
console.log('Müşteri verilerini geri yüklemek için aşağıdaki kodu tarayıcı konsolunda çalıştırın:');
console.log('restoreClients()');
